...
namespace DrakSolz.Projectiles {
    public class BlackFireBombProj : ModProjectile {
        ...
        public override void Kill(int timeLeft) {
            ...
            int proj = Projectile.NewProjectile(projectile.Center, projectile.velocity, ProjectileID.GrenadeIII, projectile.damage, 0.25f, projectile.owner);
