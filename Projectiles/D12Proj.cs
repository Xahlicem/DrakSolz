...
namespace DrakSolz.Projectiles {
    public class D12Proj : ModProjectile {

        public override void SetStaticDefaults() {
            DisplayName.SetDefault("D12"); //The English name of the projectile
        ...
        public override void SetDefaults() {
            ...
            projectile.penetrate = 12; //How many monsters the projectile can penetrate. (OnTileCollide below also decrements penetrate for bounces as well)
        ...
        public override void Kill(int timeLeft) {
            ...
            for (int i = 0; i < projectile.frame * 1 + 1; i++) {
                ...
                Main.dust[dustIndex].scale *= 0.5f;
                Item.NewItem((int) projectile.position.X, (int) projectile.position.Y, projectile.width, projectile.height, ModContent.ItemType<Items.Throwing.D12>(), 1);
            }
        }
    }
}