...
namespace DrakSolz.Projectiles.Magic {
    public class FlameMageProj : ModProjectile {
        ...
        public override void Kill(int timeLeft) {
            int proj = Projectile.NewProjectile(projectile.Center, new Vector2(0, -2), ProjectileID.DD2OgreStomp, projectile.damage, 0.25f, projectile.owner);
