...
namespace DrakSolz.Projectiles {
    public class SunlightSpearProj : ModProjectile {

        public override void SetStaticDefaults() {
            DisplayName.SetDefault("SunlightSpear"); //The English name of the projectile
        ...
        public override void SetDefaults() {
            ...
            projectile.light = 3.0f;            //How much light emit around the projectile
