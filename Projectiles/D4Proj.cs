...
namespace DrakSolz.Projectiles {
    public class D4Proj : ModProjectile {

        public override void SetStaticDefaults() {
            DisplayName.SetDefault("D4"); //The English name of the projectile
        ...
        public override void Kill(int timeLeft) {
            ...
            for (int i = 0; i < projectile.frame * 1 + 1; i++) {
                ...
                Main.dust[dustIndex].scale *= 0.5f;
                Item.NewItem((int) projectile.position.X, (int) projectile.position.Y, projectile.width, projectile.height, ModContent.ItemType<Items.Throwing.D4>(), 1);
            }
        }
    }
}