...
namespace XahlicemMod.Items.Craft
{
	class FirelinkShrine3 : ModTile
	{
		...
		{
			Item.NewItem(i * 16, j * 16, 16, 32, mod.ItemType<FirelinkShrine5>());
		}
	}

	class FirelinkShrine5 : ModItem
	{
		...
		public override void SetDefaults()
		{
			item.CloneDefaults(ItemID.Campfire);
			item.createTile = mod.TileType<FirelinkShrine3>();
		}
	}
}