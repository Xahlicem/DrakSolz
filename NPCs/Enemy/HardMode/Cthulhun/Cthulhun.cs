...
namespace DrakSolz.NPCs.Enemy.HardMode.Cthulhun {
    ...
    public class Cthulhun : ModNPC {
        ...
        public override void OnHitPlayer(Player player, int damage, bool crit) {
            player.AddBuff(ModContent.BuffType<Buffs.SlipperyBuff>(), 120, true);
        }
        ...
        public override void NPCLoot() {
            ...
            if (Main.rand.Next(3) == 0) Item.NewItem(npc.position, npc.width, npc.height, ModContent.ItemType<Items.Misc.CthulhunTentacle>(), Main.rand.Next(1, 3));
            if (Main.rand.Next(8) == 0) Item.NewItem(npc.position, npc.width, npc.height, ModContent.ItemType<Items.Misc.Twink>());
