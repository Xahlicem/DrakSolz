...
namespace DrakSolz.NPCs.Enemy.Endgame.OverWorld {
    public class BloodmoonAssassin : ModNPC {
        public override void SetStaticDefaults() {
            DisplayName.SetDefault("Bloodmoon Assassin");
        ...
        public override void SetDefaults() {
            ...
            banner = npc.type;
            bannerItem = ModContent.ItemType<Items.Banners.OverworldBanners.BloodmoonAssassinBanner>();
        }
