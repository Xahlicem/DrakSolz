...
namespace DrakSolz.NPCs.Enemy.Endgame.OverWorld {
    public class NightmareOperant : ModNPC {
        public override void SetStaticDefaults() {
            DisplayName.SetDefault("Nightmare Operant");
        ...
        public override void SetDefaults() {
            ...
            banner = npc.type;
            bannerItem = ModContent.ItemType<Items.Banners.OverworldBanners.NightmareOperantBanner>();
        }
