...
namespace DrakSolz.NPCs.Enemy.Endgame.OverWorld {
    public class ReaperNineMoons : ModNPC {
        public override void SetStaticDefaults() {
            DisplayName.SetDefault("Reaper of the Nine Moons");
        ...
        public override void SetDefaults() {
            ...
            banner = npc.type;
            bannerItem = ModContent.ItemType<Items.Banners.OverworldBanners.ReaperNineMoonsBanner>();
        }
