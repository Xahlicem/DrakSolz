...
namespace DrakSolz.NPCs.Enemy.Endgame.Hallow {
    ...
    public class HallowMod : GlobalNPC {
        ...
        public override void EditSpawnPool(IDictionary<int, float> pool, NPCSpawnInfo spawnInfo) {
            if (spawnInfo.player.ZoneHoly && spawnInfo.player.ZoneOverworldHeight && NPC.downedMoonlord) {
                pool.Clear();
            ...
            if (spawnInfo.player.ZoneHoly && spawnInfo.player.ZoneDirtLayerHeight && NPC.downedMoonlord) {
                pool.Clear();
                pool.Add(mod.NPCType<MiniSun>(), 40f);
            ...
            if (spawnInfo.player.ZoneHoly && spawnInfo.player.ZoneRockLayerHeight && NPC.downedMoonlord) {
                pool.Clear();
