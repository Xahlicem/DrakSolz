...
namespace DrakSolz.NPCs.Enemy.Endgame.Desert {
    public class AridCaster : ModNPC {
        public override void SetStaticDefaults() {
            DisplayName.SetDefault("Arid Caster");
        ...
        public override void AI() {
            ...
            if (AI_Timer == 115) {
                ...
                int pro = Projectile.NewProjectile(npc.Center.X + (20 * npc.direction), npc.Center.Y - 50, speed.X * 1.4f, speed.Y * 1.4f, ProjectileID.SapphireBolt, npc.damage, 3f);
