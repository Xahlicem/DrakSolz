...
namespace DrakSolz.NPCs.Enemy.PreHardMode.Hollow {
    ...
    public class Hollow_Base : ModNPC {
        ...
        public override void NPCLoot() {
            ...
            if (Main.rand.Next(15) == 0) Item.NewItem(npc.position, npc.width, npc.height, mod.ItemType<Items.Misc.Lifegem>());
            if (Main.rand.Next(40) == 0) Item.NewItem(npc.position, npc.width, npc.height, mod.ItemType<Items.Misc.HomewardBone>());
