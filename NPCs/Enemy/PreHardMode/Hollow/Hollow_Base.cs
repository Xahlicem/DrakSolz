...
namespace DrakSolz.NPCs.Enemy.PreHardMode.Hollow {
    ...
    public class Hollow_Base : ModNPC {
        ...
        public override float SpawnChance(NPCSpawnInfo spawnInfo) {
            return SpawnCondition.OverworldNightMonster.Chance * 0.012f;
        }
        ...
        public override void NPCLoot() {
            ...
            if (Main.rand.Next(15) == 0) Item.NewItem(npc.position, npc.width, npc.height, ModContent.ItemType<Items.Misc.Lifegem>());
            if (Main.rand.Next(40) == 0) Item.NewItem(npc.position, npc.width, npc.height, ModContent.ItemType<Items.Misc.HomewardBone>());
            if (Main.rand.Next(30) == 0) Item.NewItem(npc.position, npc.width, npc.height, ItemID.CopperShortsword, 1, false, 39);
        }
    }
}