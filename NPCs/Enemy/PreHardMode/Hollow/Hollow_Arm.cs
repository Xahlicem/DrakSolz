...
namespace DrakSolz.NPCs.Enemy.PreHardMode.Hollow {
    ...
    public class Hollow_Arm : ModNPC {
        ...
        public override void NPCLoot() {
            ...
            if (Main.rand.Next(24) == 0) Item.NewItem(npc.position, npc.width, npc.height, mod.ItemType<Items.Misc.HomewardBone>());
            if (Main.rand.Next(26) == 0) Item.NewItem(npc.position, npc.width, npc.height, ItemID.IronBroadsword, 1, false, 40);
        }
    }
}