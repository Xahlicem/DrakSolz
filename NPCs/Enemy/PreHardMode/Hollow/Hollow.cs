...
namespace DrakSolz.NPCs.Enemy.PreHardMode.Hollow {
    ...
    public class Hollow : ModNPC {
        ...
        public override void NPCLoot() {
            ...
            if (Main.rand.Next(10) == 0) Item.NewItem(npc.position, npc.width, npc.height, ModContent.ItemType<Items.Misc.Lifegem>());
            if (Main.rand.Next(30) == 0) Item.NewItem(npc.position, npc.width, npc.height, ModContent.ItemType<Items.Misc.HomewardBone>());
