...
namespace DrakSolz.NPCs.Enemy {
    ...
    public class AbyssStalker : ModNPC {
		...
		public override string[] AltTextures {
			get {return new String[]{"DrakSolz/NPCs/Enemy/AbyssStalker_1", "DrakSolz/NPCs/Enemy/AbyssStalker_2"};}
		}
        ...
        public override void AI() {
            ...
            // In this state, a player has been targeted
				...
				if (AI_Timer == 22) 
                    if (Main.netMode != 1) {
                        int proj = Projectile.NewProjectile(npc.Center, GetVelocity(Main.player[npc.target]), ProjectileID.LostSoulHostile, npc.damage * 2, 2f);
