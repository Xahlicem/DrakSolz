...
namespace DrakSolz.Tiles {
    ...
    public class LotteryMachineTile : ModTile {
        ...
        public override bool NewRightClick(int i, int j) {
            ...
            int coin = player.FindItem(ItemID.GoldCoin);
            if (coin >= 0) {
                player.inventory[coin].stack -= 1;
                Main.PlaySound(SoundID.CoinPickup, player.position);

                int itemType = 0, soundType = 0, stack = 1;
                ...
                if (c >= 999) {
                    ...
                    ModContent.ItemType<Items.Melee.ShinkagesKatana>(),
                    ...
                    ModContent.ItemType<Items.Magic.HereticSpell>(),
                    ModContent.ItemType<Items.Melee.SoulShatter>(),
                    ...
                    ModContent.ItemType<Items.Ranged.DivineCannon>(),
                    ...
                    ModContent.ItemType<Items.Throwing.SpinningAxe>(),
                ...
                if (text != player.name) Main.NewText(text, color);
                if (soundType != 0) Main.PlaySound(soundType, player.position);
            }
            return false;
        }
