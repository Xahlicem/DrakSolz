...
namespace DrakSolz.Tiles {
    ...
    public class LordVesselTile : ModTile {
        public override void SetDefaults () {
        ...
        public override void KillMultiTile (int i, int j, int frameX, int frameY) {
            Item.NewItem (i * 16, j * 16, 32, 16, ModContent.ItemType<Tiles.LordVessel> ());
        }
        ...
        public override void MouseOver (int i, int j) {
            ...
            player.showItemIcon2 = ModContent.ItemType<Tiles.LordVessel> ();
        }
        ...
        public class LordVesselGlobalNPC : GlobalNPC {
            public override void NPCLoot(NPC npc) {
                if (Main.rand.Next(10) == 0) {
                    if (npc.type == NPCID.FireImp) {
                        Item.NewItem((int) npc.position.X, (int) npc.position.Y, npc.width, npc.height, ModContent.ItemType<Tiles.LordVessel>(), 1);
                    }
                }
            }
        }
